...
void histos() {
  ...
  TH1F *heventID = new TH1F("heventID", "ID distribution", 2410, -120, 120);

  TH1F *hpr = new TH1F("hpr", "Pattern Register", 20, 0., 20.);
  TH1F *htof = new TH1F("htof", "Time of Flight", 1000, 1500., 3500.);
  ...
  TH1F *hX1posa = new TH1F("hX1posa", "X1 Position", 3200, -600., 600.);
  TH1F *hX1posb = new TH1F("hX1posb", "X1 Position", 3200, -600., 600.);
  TH1F *hX1posc = new TH1F("hX1posc", "X1 Position", 3200, -600., 600.);
  TH1F *hX1posd = new TH1F("hX1posd", "X1 Position", 3200, -600., 600.);

  TH1F *hX1back1 = new TH1F("hX1back1", "X1 background", 1600, -600., 600.);
  TH1F *hX1back2 = new TH1F("hX1back2", "X1 background", 1600, -600., 600.);
  TH1F *hX1diff = new TH1F("hX1diff", "X1 difference plot", 1600, -600., 600.);
  TH1F *hX1pos2 = new TH1F("hX1pos2", "X1 Position", 4000, -600., 600.);
  TH1F *hX1pos3 = new TH1F("hX1pos3", "X1 Position", 1600, -600., 600.);
  TH1F *hX1posLoRes = new TH1F("hX1posLoRes", "X1 Position", 800, -600., 600.);
  TH1F *hX1posHiRes = new TH1F("hX1posHiRes", "X1 Position", 4000, -600., 600.);
  ...
  TH2F *hpad1vstoftdc7 =
      new TH2F("hpad1vstoftdc7", "Scint 1 vs time of flight: TDC7", 1500, 3500.,
               5000., 2000, 0., 4000.);
  TH2F *hpad2vstof = new TH2F("hpad2vstof", "Scint 2 vs time of flight", 1500,
                              4000., 5500., 2000, 0., 4000.);
  ...
  TH2F *hY1vsX1 =
      new TH2F("hY1vsX1", "Y1 vs X1", 2400, -600., 600., 320, -80., 80.);
  TH2F *hY2vsX1 =
      new TH2F("hY2vsX1", "Y2 vs X1", 2400, -600., 600., 280, -70., 70.);
  TH2F *hY1vsY2 =
  ...
  TH2F *hX1ResvsX1 =
      new TH2F("hX1ResvsX1", "Res vs X1", 1600, -600., 600., 120, -6., 6.);
  TH2F *hX1ResvsThFP =
  ...
  TH2F *hU1vsX1 =
      new TH2F("hU1vsX1", "U1 vs X1", 2400, -600., 600., 2400, 0., 800.);
  ...
  TH2F *hX1vschi =
      new TH2F("hX1vschi", "X1pos vs chisq", 800, -600., 600., 200, 0, 1);
  ...
  TH2F *hX1dtvsX =
      new TH2F("hX1dtvsX", "X1 offset corrected drifttime vs X1pos", 800, -600.,
               600., 150, 0., 15000.);
}
